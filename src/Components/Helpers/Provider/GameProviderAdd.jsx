...
console.log(location?.state)
  const formik = PagesIndex.useFormik({
    initialValues:{
      ...
      activeStatus:location?.activeStatus ? location?.state?.activeStatus :false,
    ...
    onSubmit:async(values)=>{
      ...
      try {
          ...
          activeStatus:values.activeStatus
            ...
            const res = await PagesIndex.admin_services.GAME_PROVIDER_ADD_API(data)
...
<PagesIndex.Formikform fieldtype={fields.filter((field) => !field.showWhen)}
          formik={formik}
